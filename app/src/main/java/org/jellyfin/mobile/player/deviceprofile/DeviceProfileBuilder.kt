...
class DeviceProfileBuilder(
    ...
    init {
        ...
        supportedVideoCodecs =
            Array(AVAILABLE_VIDEO_CODECS.size) { i ->
                AVAILABLE_VIDEO_CODECS[i]
                    .filter { codec ->
                        videoCodecs.containsKey(codec)
                    }.toTypedArray()
            }
        supportedAudioCodecs =
            Array(AVAILABLE_AUDIO_CODECS.size) { i ->
                AVAILABLE_AUDIO_CODECS[i]
                    .filter { codec ->
    ...
    private fun getSubtitleProfiles(
    ...
    fun getExternalPlayerProfile(): DeviceProfile =
        DeviceProfile(
    ...
    companion object {
        ...
        private val EXTERNAL_PLAYER_SUBTITLES =
            arrayOf(
                "ass",
                "dvbsub",
                "pgssub",
        ...
        private val MPV_EMBEDDED_SUBTITLES =
            arrayOf("dvbsub", "pgssub", "srt", "subrip", "ttml", "ssa", "ass", "dvdsub")
