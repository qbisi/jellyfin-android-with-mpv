...
class SettingsFragment :
    ...
    private fun buildSettingsScreen() =
        screen(requireContext()) {
            ...
            val videoPlayerOptions =
                listOf(
                    SelectionItem(
                        VideoPlayerType.WEB_PLAYER,
                        R.string.video_player_web,
                        R.string.video_player_web_description,
                    ),
                    SelectionItem(
            ...
            startLandscapeVideoInLandscapePreference =
                checkBox(Constants.PREF_EXOPLAYER_START_LANDSCAPE_VIDEO_IN_LANDSCAPE) {
                    titleRes = R.string.pref_exoplayer_start_landscape_video_in_landscape
                    enabled = appPreferences.videoPlayerType == VideoPlayerType.EXO_PLAYER
                }
            swipeGesturesPreference =
                checkBox(Constants.PREF_EXOPLAYER_ALLOW_SWIPE_GESTURES) {
            ...
            rememberBrightnessPreference =
                checkBox(Constants.PREF_EXOPLAYER_REMEMBER_BRIGHTNESS) {
            ...
            pressSpeedUpPreference =
                checkBox(Constants.PREF_EXOPLAYER_ALLOW_PRESS_SPEED_UP) {
            ...
            directPlayAssPreference =
                checkBox(Constants.PREF_EXOPLAYER_DIRECT_PLAY_ASS) {
                    titleRes = R.string.pref_exoplayer_direct_play_ass
                    summaryRes = R.string.pref_exoplayer_direct_play_ass_summary
                    enabled = appPreferences.videoPlayerType == VideoPlayerType.EXO_PLAYER
                }

            mpvUseEmbedFontPreference =
                checkBox(Constants.PREF_MPV_USE_EMBED_FONT) {
            ...
            externalPlayerChoicePreference =
                singleChoice(Constants.PREF_EXTERNAL_PLAYER_APP, externalPlayerOptions) {
            ...
            val downloadsDirs =
                requireContext().getDownloadsPaths().map { path ->
